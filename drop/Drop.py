...
class DropController(EventEmitter):
    ...
    def remove_sensor(self, sensor_id):
        '''
        Go through sensors and disconnect the sensor with the provided
        sensor_id.
        '''
    ...
    def on_tag(self, tag):
        ''' Sends a tag to all sensors. Tag might not come instantly here so the
    ...
    def experiment_start(self, debug):
        ''' Things to perform when experiment is started. '''
    ...
    def on_data_condition_added(self, data_condition):
        '''
        Function for the data-condition input from the experiment.
        Calls all sensors.
        '''
    ...
    def stop_collecting_data(self, callback):
        '''
        Function stops data collection on all sensors and runs callback
        after.
        '''
